...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <!--sidebar nav start-->
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="active"><a href="#"><i class="fa fa-home"></i> <span>我的主页</span></a></li>
                ...
                <li class="menu-list"><a href="#"><i class="fa fa-book"></i> <span>规划及成果管理</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="#"> 资料管理</a></li>
                        <li><a href="#"> 查询统计</a></li>
                        <li><a href="#">资源分析</a></li>
                ...
                <li class="menu-list"><a href="#"><i class="fa fa-cogs"></i> <span>项目过程监督</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="#"> 资料管理</a></li>
                        <li><a href="#">查询统计</a></li>
                        <li><a href="#">过程监控</a></li>
                ...
                <li class="menu-list"><a href="#"><i class="fa fa-envelope"></i> <span>地理信息管理</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="#">基本gis操作</a></li>
                        <li><a href="#">图层管理</a></li>
                        <li><a href="#">对象标绘</a></li>
                        <li><a href="#">空间分析</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href="#"><i class="fa fa-tasks"></i> <span>多维分析</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="#">切片切换</a></li>
                        <li><a href="#">数据钻取</a></li>
                        <li><a href="#">对比分析</a></li>
                    ...
                    <li>
                        ...
                        <div class="dropdown-menu dropdown-menu-head pull-right">
                            ...
                            <ul class="dropdown-list normal-list">
                                <li class="new">
                                    <a href="#">
                                        <span class="thumb"><img src="/statics/images/photos/user1.png" alt=""/></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="thumb"><img src="/statics/images/photos/user2.png" alt=""/></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="thumb"><img src="/statics/images/photos/user3.png" alt=""/></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="thumb"><img src="/statics/images/photos/user4.png" alt=""/></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="thumb"><img src="/statics/images/photos/user5.png" alt=""/></span>
                                        <span class="desc">
                    ...
                    <div class="panel">
                        <header class="panel-heading">
                            ...
                            <span class="tools pull-right">
                                <a href="/statics/javascript:;" class="fa fa-chevron-down"></a>
                                <a href="/statics/javascript:;" class="fa fa-times"></a>
                             </span>
                        </header>
                        <div class="panel-body">
                            <ul class="goal-progress">
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/statics/images/photos/user1.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="#">管理员</a> - Project Lead
                                        </div>
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/statics/images/photos/user2.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/statics/images/photos/user3.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/statics/images/photos/user4.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                ...
                <div class="col-md-4">
                    <div class="panel">
                        <header class="panel-heading">
                            Todo List
                            <span class="tools pull-right">
                                <a class="fa fa-chevron-down" href="/statics/javascript:;"></a>
                                <a class="fa fa-times" href="/statics/javascript:;"></a>
                             </span>
                        </header>
                        <div class="panel-body">
                        ...
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="#" class="pull-left">
                                    <img class="thumb" src="/statics/images/photos/user2.png" alt=""/>
                                </a>
